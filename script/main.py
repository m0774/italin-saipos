...
input_path = os.path.join(BASE_DIR, 'objeto.txt')
...
for feature in data:
    if feature['geometry']['type'] == 'Point':
        ...
        origin_point = (coords[0], coords[1])  # <-------- Se der erro precisa inverter esse 0 e 1 (às vezes a Saipos envia invertido no object)
...
output_path = os.path.join(saida_dir, 'italin-saipos.kml')
